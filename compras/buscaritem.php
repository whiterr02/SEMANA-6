...
if ($action == 'ajax') {
    ...
    $sFields = "
    `articulos`.`idArticulo`,`articulos`.`descripcion`,round(`articulos`.`preciocompra`,0) as preciocompra,round(`articulos`.`precioventa`,0) as precioventa";
        ...
        <div class="table-responsive">
            <table class="table">
                <tr class="warning">
                    ...
                    <th><span class="float-right">Precio Compra</span></th>
